...
// ─── OVERLAY_SCRIPT — compiled IIFE for page.addInitScript() injection ────────
// Pre-compiled plain-JS version of the overlay logic above. Injected into the
// recording page by the CLI (cli.ts) via page.addInitScript(OVERLAY_SCRIPT).
